...
Use the credentials generated by the seeder to access the admin portal, then create products, customers, and user accounts 
to fully see the system's functionality
